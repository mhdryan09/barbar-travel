                            ...
                            <div class="join-trip">
                                <table class="table table-responsive-sm text-center">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="{{ url('/frontend/images/checkout/ck_member_1.png') }}" alt="">
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{ url('/frontend/images/checkout/ck_member_2.png') }}" alt="">
                                            </td>
    ...
    <script>
        $(document).ready(function() {
            $(".datepicker").datepicker({
                ...
                icons: {
                    rightIcon: '<img src="{{ url('frontend/libraries/gjigo/js/gijgo.js') }}" />'
                }
            });
        });
    </script>
